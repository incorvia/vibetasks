  ...
  time_log: extend(common("time_log"), {
    ...
    meeting_completions: {
      type: "array", items: { type: "object", additionalProperties: false,
        required: ["calendar_id", "event_id", "occurrence_start", "completed_at"], properties: {
          calendar_id: { type: "string", minLength: 1 }, event_id: { type: "string", minLength: 1 },
          occurrence_start: { type: "string", minLength: 1 }, completed_at: { type: "string", format: "date-time" },
        } },
    },
