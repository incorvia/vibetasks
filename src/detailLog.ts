...
// Kommentar-Log (Details) – 1:1 zum alten Opal Tasks (tasks-utils.js). Einträge stehen
...
export const LOG_HEADING = "###### Opal Tasks Details-Logbuch";
const isLogHead = (l: string): boolean => /^#{1,6}\s+Opal Tasks Details-Logbuch\s*$/.test(l);
