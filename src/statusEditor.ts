...
export function renderStatusEditor(container: HTMLElement, plugin: OpalTasksPlugin): void {
  container.empty();
...
function statusRow(list: HTMLElement, plugin: OpalTasksPlugin, s: StoredStatus, groupCount: number, roles: StatusRoles, persist: () => void, redraw: () => void): void {
...
function startStatusRename(row: HTMLElement, plugin: OpalTasksPlugin, s: StoredStatus, redraw: () => void): void {
  row.empty();
 ...
 */
function startStatusIdEdit(row: HTMLElement, plugin: OpalTasksPlugin, s: StoredStatus, redraw: () => void): void {
  row.empty();
...
function openKindPicker(anchor: HTMLElement, plugin: OpalTasksPlugin, s: StoredStatus, redraw: () => void): void {
...
function openIconPicker(anchor: HTMLElement, plugin: OpalTasksPlugin, s: StoredStatus, redraw: () => void): void {
  openPopover(anchor, (pop, close) => {
