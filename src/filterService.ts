...
import { OpalTasksSettings } from "./types";
...
export async function createFilterNote(
  app: App, settings: OpalTasksSettings, name: string, criteria: FilterCriteria, options: ViewOptions, color: string | null = null, hidden = false, description = "",
): Promise<string> {
